...
- `remove-run-condition-match`: indicates whether to remove the match of run-condition-regex from title (default: `false`)
- `remove-branch-name-from-title`: indicates whether to remove the existing branch name and surrounding whitespace from title (default: `false`)
